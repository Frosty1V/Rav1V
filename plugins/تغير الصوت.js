...
if (/تشويه/.test(command)) set = '-af volume=12'
if (/سريع/.test(command)) set = '-filter:a "atempo=1.63,asetrate=44100"'
if (/تخين/.test(command)) set = '-filter:a "atempo=1.6,asetrate=22100"'
...
} else throw `*المرجو الاشارة للريكورد او المقطع الصوتي الذي تريد التعديل عليه${usedPrefix + command}*`
} catch (e) { 
throw e
}}
handler.help = ['bass', 'blown', 'deep', 'earrape', 'fast', 'fat', 'nightcore', 'reverse', 'robot', 'slow', 'smooth', 'tupai']
handler.tags = ['audio-changer']
handler.command = /^(منفوخ|عميق|تشويه|سريع|عكس|روبوت|بطئ|سلس|تخين)$/i
